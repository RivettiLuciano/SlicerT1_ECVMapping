...
You can watch the [tutorial video](https://www.youtube.com/watch?v=K2bdrP7XCqk) in order to see how to use this module. Try to follow the tutorial steps downloading the [Sample Data](https://github.com/RivettiLuciano/SlicerT1_ECVMapping/releases/download/v1.0/Sample1.zip).
